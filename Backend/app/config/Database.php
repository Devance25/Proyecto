...
class Database {
    ...
    private string $user = "user_devance";        // Usuario de la base de datos
    private string $password = "S3cUr3!p@55W0rD#9x";  // Contraseña del usuario
    private string $dbname = "bd-devance"; // Nombre de la base de datos
